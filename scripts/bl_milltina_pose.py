...
FRAMES = [
    ...
    # 手臂路径（穿模扫描器标定 v2）：左臂前推出胸（y 更负=更靠前），右臂全程低位
    # 外侧滑向桌沿（此前抬经头侧扫到双马尾 pen0.16、横穿胸前 pen0.28）
    ...
    (22, {"mixamorig:Hips": (0.04, 0, 0), "mixamorig:Spine": (0.06, 0, 0), "mixamorig:Spine1": (0.05, 0, 0),
     ...
     (0.15, -0.14, 0.78), (0.17, -0.09, 0.79), (-0.16, -0.12, 0.72), (-0.17, -0.07, 0.75)),
    (28, {"mixamorig:Hips": (0.06, 0, 0), "mixamorig:Spine": (0.09, 0, 0), "mixamorig:Spine1": (0.075, 0, 0),
     ...
     (0.12, -0.12, 0.87), (0.18, -0.10, 0.83), (-0.14, -0.11, 0.78), (-0.18, -0.09, 0.80)),
    (40, {"mixamorig:Hips": (0.09, 0, 0), "mixamorig:Spine": (0.125, 0, 0), "mixamorig:Spine1": (0.105, 0, 0),
     ...
     (0.07, -0.10, 0.93), (0.185, -0.10, 0.842), (-0.05, -0.10, 0.82), (-0.175, -0.09, 0.84)),
