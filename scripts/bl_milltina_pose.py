...
FRAMES = [
    ...
    # 手臂路径（穿模扫描器标定 v3）：躯干前倾会把胸转进原地不动的手臂——中后段双臂
    # 整体前推（y 更负=离胸更远）：右前臂从"贴胸沿桌沿"改为胸前一掌距横放桌面，
    # 左手上举走胸前外弧、只在 f55 终点贴颊（此前 t1.5 掌贴胸、t2.0 右前臂 pen0.41）
    (16, {"mixamorig:Hips": (0.02, 0, 0), "mixamorig:Spine": (0.03, 0, 0), "mixamorig:Spine1": (0.025, 0, 0),
     ...
     (0.13, -0.16, 0.68), (0.14, -0.08, 0.74), (-0.13, -0.13, 0.66), (-0.15, -0.07, 0.72)),
    (22, {"mixamorig:Hips": (0.04, 0, 0), "mixamorig:Spine": (0.06, 0, 0), "mixamorig:Spine1": (0.05, 0, 0),
     ...
     (0.15, -0.145, 0.78), (0.17, -0.095, 0.79), (-0.16, -0.125, 0.72), (-0.17, -0.08, 0.75)),
    (28, {"mixamorig:Hips": (0.06, 0, 0), "mixamorig:Spine": (0.09, 0, 0), "mixamorig:Spine1": (0.075, 0, 0),
     ...
     (0.12, -0.15, 0.87), (0.18, -0.115, 0.83), (-0.14, -0.125, 0.78), (-0.18, -0.10, 0.80)),
    (40, {"mixamorig:Hips": (0.09, 0, 0), "mixamorig:Spine": (0.125, 0, 0), "mixamorig:Spine1": (0.105, 0, 0),
     ...
     (0.07, -0.13, 0.93), (0.185, -0.115, 0.842), (-0.05, -0.135, 0.825), (-0.17, -0.105, 0.84)),
    (48, {"mixamorig:Hips": (0.12, 0, 0), "mixamorig:Spine": (0.15, 0, 0), "mixamorig:Spine1": (0.125, 0, 0),
     ...
     (0.058, -0.10, 0.965), (0.185, -0.11, 0.838), (-0.015, -0.125, 0.838), (-0.16, -0.105, 0.842)),
    (55, {"mixamorig:Hips": (0.11, 0, 0), "mixamorig:Spine": (0.14, 0, 0), "mixamorig:Spine1": (0.115, 0, 0),
     ...
     (0.058, -0.09, 0.96), (0.185, -0.10, 0.840), (-0.015, -0.12, 0.840), (-0.16, -0.105, 0.842)),
]
prevL = None
prevR = None
dealL = None
