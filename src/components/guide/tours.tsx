  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: (
          <>
            人物卡的图位由第 1 步选的<b className="font-bold text-slate-100">方案</b>决定；其余卡种由卡种决定
            （一把剑不该有「全身立绘」），换卡种时对不上的格子会被取下来并当场告诉你。
            <b className="font-bold text-slate-100">第一格既是卡面也是主形象参考</b>：
