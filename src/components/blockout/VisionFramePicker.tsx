...
// ★ 另有一条兜底不在这里，在服务端的提示词里：**清单之外的人也一律白模化，但不给编号**
//   （宁可让它没号、挂不了卡，也不要出现一个列表里没有的号）。
//
  ...
  return (
    <div className="space-y-2 rounded-lg border border-slate-700 bg-panel/60 px-3 py-2.5">
      ...
      <p className="text-[10px] leading-relaxed text-slate-500">
        ...
        逐个点名替换成带编号的白模人偶。<b className="text-amber-300">看漏了人，出片时那个人也会被换成白模，
        但拿不到编号</b>——他会一直保持白模人偶的样子，谁的卡都挂不上去。
      </p>
