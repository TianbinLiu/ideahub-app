  ...
  return (
    <div className="space-y-3">
      ...
      {/* 没挂满不拦 —— 但必须说清没挂的会怎样（不说的话用户会以为"没挂 = 那个人不出现"）。
          ★★★ 「不会自动变成别人」那半句 2026-08-18 被第十二发实拍**证伪**了，不能再说：
            切镜多的素材上，两个没挂卡的白位被 AI 拿**已挂的卡**复制着换掉了（同一个角色
            出现两份），另一个场景的中心位也被换错。单镜头素材没这个问题（第十发：
            部分挂卡、没挂的四位全部原样）。⇒ 这句话按实测分两截说：通常原样 + 什么时候例外。
